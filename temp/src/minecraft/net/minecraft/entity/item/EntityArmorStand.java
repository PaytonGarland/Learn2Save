...
public class EntityArmorStand extends EntityLivingBase {
   ...
   public ItemStack func_184582_a(EntityEquipmentSlot p_184582_1_) {
      ...
      case HAND:
         return (ItemStack)this.field_184799_bw.get(p_184582_1_.func_188454_b());
      case ARMOR:
         return (ItemStack)this.field_184800_bx.get(p_184582_1_.func_188454_b());
      default:
   ...
   private void func_175409_C() {
      ...
      for(int j = 0; j < this.field_184800_bx.size(); ++j) {
         ItemStack itemstack1 = (ItemStack)this.field_184800_bx.get(j);
         if(!itemstack1.func_190926_b()) {
