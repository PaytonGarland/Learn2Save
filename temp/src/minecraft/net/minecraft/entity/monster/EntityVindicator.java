...
public class EntityVindicator extends EntityMob {
   protected static final DataParameter<Byte> field_190642_a = EntityDataManager.<Byte>func_187226_a(EntityVindicator.class, DataSerializers.field_187191_a);
   ...
   protected void func_70088_a() {
      super.func_70088_a();
      this.field_70180_af.func_187214_a(field_190642_a, Byte.valueOf((byte)0));
   }
   ...
   private boolean func_190637_a(int p_190637_1_) {
      int i = ((Byte)this.field_70180_af.func_187225_a(field_190642_a)).byteValue();
   ...
   private void func_190638_a(int p_190638_1_, boolean p_190638_2_) {
      ...
      this.field_70180_af.func_187227_b(field_190642_a, Byte.valueOf((byte)(i & 255)));
   }
   ...
   public void func_190636_a(boolean p_190636_1_) {
      ...
      if(this.func_184582_a(EntityEquipmentSlot.MAINHAND) == ItemStack.field_190927_a) {
   ...
   public boolean func_184191_r(Entity p_184191_1_) {
      return super.func_184191_r(p_184191_1_)?true:(p_184191_1_ instanceof EntityLivingBase && ((EntityLivingBase)p_184191_1_).func_70668_bt() == EnumCreatureAttribute.ILLAGER?this.func_96124_cp() == null && p_184191_1_.func_96124_cp() == null:false);
   }
