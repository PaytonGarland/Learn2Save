   ...
   public boolean func_75250_a() {
      if(this.field_75332_b.func_70681_au().nextFloat() >= this.field_75331_e) {
         ...
         if(this.field_75329_f == EntityPlayer.class) {
            Predicate<Entity> predicate = Predicates.<Entity>and(EntitySelectors.field_180132_d, EntitySelectors.func_191324_b(this.field_75332_b));
            this.field_75334_a = this.field_75332_b.field_70170_p.func_190525_a(this.field_75332_b.field_70165_t, this.field_75332_b.field_70163_u, this.field_75332_b.field_70161_v, (double)this.field_75333_c, predicate);
         } else {
