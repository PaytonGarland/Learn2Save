...
public final class ItemStack {
   ...
   public List<String> func_82840_a(EntityPlayer p_82840_1_, boolean p_82840_2_) {
      ...
      if((i1 & 32) == 0) {
         this.func_77973_b().func_77624_a(this, p_82840_1_, list, p_82840_2_);
      }
      ...
      if(this.func_77942_o()) {
         ...
         if(this.field_77990_d.func_150297_b("display", 10)) {
            ...
            if(nbttagcompound.func_150297_b("color", 3)) {
               if(p_82840_2_) {
                  list.add(I18n.func_74837_a("item.color", new Object[]{String.format("#%06X", new Object[]{Integer.valueOf(nbttagcompound.func_74762_e("color"))})}));
               } else {
      ...
      if(p_82840_2_) {
         if(this.func_77951_h()) {
            list.add(I18n.func_74837_a("item.durability", new Object[]{Integer.valueOf(this.func_77958_k() - this.func_77952_i()), Integer.valueOf(this.func_77958_k())}));
         }

         list.add(TextFormatting.DARK_GRAY + ((ResourceLocation)Item.field_150901_e.func_177774_c(this.field_151002_e)).toString());
         if(this.func_77942_o()) {
            list.add(TextFormatting.DARK_GRAY + I18n.func_74837_a("item.nbt_tags", new Object[]{Integer.valueOf(this.func_77978_p().func_150296_c().size())}));
         }
      }
