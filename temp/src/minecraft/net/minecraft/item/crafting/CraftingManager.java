...
public class CraftingManager {
   ...
   private CraftingManager() {
      ...
      this.func_92103_a(new ItemStack(Blocks.field_190976_dk, 1), new Object[]{"###", "RRQ", "###", Character.valueOf('#'), Blocks.field_150347_e, Character.valueOf('R'), Items.field_151137_ax, Character.valueOf('Q'), Items.field_151128_bU});
