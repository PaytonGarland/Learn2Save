         ...
         if(structureendcitypieces$citytemplate1 != null) {
            for(Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186205_e) {
               if(p_191086_6_.nextBoolean()) {
                  StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate2 = StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate1, (BlockPos)tuple.func_76340_b(), "bridge_end", rotation.func_185830_a((Rotation)tuple.func_76341_a()), true));
      ...
      public boolean func_191086_a(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_) {
         ...
         for(int i = 0; i < 2 && p_191086_6_.nextInt(3) != 0; ++i) {
            ...
            for(Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.field_186208_h) {
               if(p_191086_6_.nextBoolean()) {
                  StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1 = StructureEndCityPieces.func_189935_b(p_191086_5_, StructureEndCityPieces.func_191090_b(p_191086_1_, structureendcitypieces$citytemplate, (BlockPos)tuple.func_76340_b(), "bridge_end", rotation.func_185830_a((Rotation)tuple.func_76341_a()), true));
