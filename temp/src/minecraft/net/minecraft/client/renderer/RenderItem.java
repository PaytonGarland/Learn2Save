...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void func_175035_a(IBakedModel p_175035_1_, int p_175035_2_) {
      this.func_175045_a(p_175035_1_, p_175035_2_, ItemStack.field_190927_a);
   }
   ...
   private void func_175032_a(VertexBuffer p_175032_1_, List<BakedQuad> p_175032_2_, int p_175032_3_, ItemStack p_175032_4_) {
      boolean flag = p_175032_3_ == -1 && !p_175032_4_.func_190926_b();
      int i = 0;
   ...
   public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, @Nullable String p_180453_5_) {
      if(!p_180453_2_.func_190926_b()) {
         ...
         if(f3 > 0.0F) {
            ...
            this.func_181565_a(vertexbuffer1, p_180453_3_, p_180453_4_ + MathHelper.func_76141_d(16.0F * (1.0F - f3)), 16, MathHelper.func_76123_f(16.0F * f3), 255, 255, 255, 127);
            GlStateManager.func_179098_w();
            GlStateManager.func_179145_e();
            GlStateManager.func_179126_j();
         }
