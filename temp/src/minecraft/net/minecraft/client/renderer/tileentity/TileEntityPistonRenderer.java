...
public class TileEntityPistonRenderer extends TileEntitySpecialRenderer<TileEntityPiston> {
   ...
   public void func_180535_a(TileEntityPiston p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      ...
      if(iblockstate.func_185904_a() != Material.field_151579_a && p_180535_1_.func_145860_a(p_180535_8_) < 1.0F) {
         ...
         vertexbuffer.func_178969_c(p_180535_2_ - (double)blockpos.func_177958_n() + (double)p_180535_1_.func_174929_b(p_180535_8_), p_180535_4_ - (double)blockpos.func_177956_o() + (double)p_180535_1_.func_174928_c(p_180535_8_), p_180535_6_ - (double)blockpos.func_177952_p() + (double)p_180535_1_.func_174926_d(p_180535_8_));
         World world = this.func_178459_a();
         if(block == Blocks.field_150332_K && p_180535_1_.func_145860_a(p_180535_8_) <= 0.25F) {
            ...
            vertexbuffer.func_178969_c(p_180535_2_ - (double)blockpos.func_177958_n(), p_180535_4_ - (double)blockpos.func_177956_o(), p_180535_6_ - (double)blockpos.func_177952_p());
