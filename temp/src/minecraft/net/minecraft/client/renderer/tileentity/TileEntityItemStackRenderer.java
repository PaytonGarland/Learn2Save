...
public class TileEntityItemStackRenderer {
   ...
   public void func_179022_a(ItemStack p_179022_1_) {
      Item item = p_179022_1_.func_77973_b();
      if(item == Items.field_179564_cE) {
         this.field_179024_e.func_175112_a(p_179022_1_, false);
         ...
         if(p_179022_1_.func_179543_a("BlockEntityTag") != null) {
            this.field_179024_e.func_175112_a(p_179022_1_, true);
         ...
         if(TileEntitySkullRenderer.field_147536_b != null) {
            ...
            TileEntitySkullRenderer.field_147536_b.func_188190_a(0.0F, 0.0F, 0.0F, EnumFacing.UP, 180.0F, p_179022_1_.func_77960_j(), gameprofile, -1, 0.0F);
