...
public class TileEntityEndPortalRenderer extends TileEntitySpecialRenderer<TileEntityEndPortal> {
   ...
   public void func_180535_a(TileEntityEndPortal p_180535_1_, double p_180535_2_, double p_180535_4_, double p_180535_6_, float p_180535_8_, int p_180535_9_) {
      ...
      double d0 = p_180535_2_ * p_180535_2_ + p_180535_4_ * p_180535_4_ + p_180535_6_ * p_180535_6_;
      ...
      for(int j = 0; j < i; ++j) {
         ...
         if(p_180535_1_.func_184313_a(EnumFacing.SOUTH)) {
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + 1.0D, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + 1.0D, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
         }

         if(p_180535_1_.func_184313_a(EnumFacing.NORTH)) {
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + 1.0D, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + 1.0D, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
         }
         ...
         if(p_180535_1_.func_184313_a(EnumFacing.UP)) {
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + (double)f, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + (double)f, p_180535_6_ + 1.0D).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_ + 1.0D, p_180535_4_ + (double)f, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
            vertexbuffer.func_181662_b(p_180535_2_, p_180535_4_ + (double)f, p_180535_6_).func_181666_a(f3, f4, f5, 1.0F).func_181675_d();
         }
