...
public class ModelBakery {
   ...
   private void func_177569_a(ModelBlockDefinition p_177569_1_, ModelResourceLocation p_177569_2_) {
      try {
         ...
         if(!p_177569_1_.func_188002_b()) {
            field_177603_c.warn("Unable to load variant: {} from {}", new Object[]{p_177569_2_.func_177518_c(), p_177569_2_});
         }
      }
   ...
   private void func_177592_e() {
      ...
      this.field_177613_u.put(Item.func_150898_a(Blocks.field_150350_a), Collections.<String>emptyList());
