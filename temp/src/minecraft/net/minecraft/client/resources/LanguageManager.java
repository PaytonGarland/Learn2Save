   ...
   public void func_135043_a(List<IResourcePack> p_135043_1_) {
      ...
      for(IResourcePack iresourcepack : p_135043_1_) {
         try {
            ...
            field_147648_b.warn("Unable to parse language metadata section of resourcepack: {}", new Object[]{iresourcepack.func_130077_b(), runtimeexception});
         } catch (IOException ioexception) {
            field_147648_b.warn("Unable to parse language metadata section of resourcepack: {}", new Object[]{iresourcepack.func_130077_b(), ioexception});
         }
      }
