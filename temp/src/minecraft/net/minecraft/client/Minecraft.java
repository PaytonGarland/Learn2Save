...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   private void func_190521_a(String p_190521_1_, Object... p_190521_2_) {
      this.field_71456_v.func_146158_b().func_146227_a((new TextComponentString("")).func_150257_a((new TextComponentString("[Debug]: ")).func_150255_a((new Style()).func_150238_a(TextFormatting.YELLOW).func_150227_a(Boolean.valueOf(true)))).func_150257_a(new TextComponentTranslation(p_190521_1_, p_190521_2_)));
   }
