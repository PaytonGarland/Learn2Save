         ...
         if(nbttagcompound1.func_150297_b("Items", 9)) {
            ...
            for(ItemStack itemstack : nonnulllist) {
               if(!itemstack.func_190926_b()) {
                  ...
                  if(i <= 4) {
                     ++i;
                     p_190948_3_.add(String.format("%s x%d", new Object[]{itemstack.func_82833_r(), Integer.valueOf(itemstack.func_190916_E())}));
                  }
               }
            }

            if(j - i > 0) {
               p_190948_3_.add(String.format(TextFormatting.ITALIC + I18n.func_74838_a("container.shulkerBox.more"), new Object[]{Integer.valueOf(j - i)}));
            }
         }
      }
