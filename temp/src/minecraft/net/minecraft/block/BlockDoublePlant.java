...
public class BlockDoublePlant extends BlockBush implements IGrowable {
   ...
   public Item func_180660_a(IBlockState p_180660_1_, Random p_180660_2_, int p_180660_3_) {
      if(p_180660_1_.func_177229_b(field_176492_b) == BlockDoublePlant.EnumBlockHalf.UPPER) {
         ...
         return blockdoubleplant$enumplanttype == BlockDoublePlant.EnumPlantType.FERN?Items.field_190931_a:(blockdoubleplant$enumplanttype == BlockDoublePlant.EnumPlantType.GRASS?(p_180660_2_.nextInt(8) == 0?Items.field_151014_N:Items.field_190931_a):super.func_180660_a(p_180660_1_, p_180660_2_, p_180660_3_));
      }
   }
   ...
   public void func_149666_a(Item p_149666_1_, CreativeTabs p_149666_2_, NonNullList<ItemStack> p_149666_3_) {
