...
public class DedicatedServer extends MinecraftServer implements IServer {
   ...
   private final List<PendingCommand> field_71341_l = Collections.<PendingCommand>synchronizedList(Lists.<PendingCommand>newArrayList());
   ...
   public boolean func_71197_b() throws IOException {
      ...
      thread.start();
      field_155771_h.info("Starting minecraft server version 1.11.2");
      ...
      if(!this.field_154332_n.func_154346_a()) {
         ...
         field_155771_h.info("Default game type: {}", new Object[]{this.field_71337_q});
         ...
         field_155771_h.info("Starting Minecraft server on {}:{}", new Object[]{this.func_71211_k().isEmpty()?"*":this.func_71211_k(), Integer.valueOf(this.func_71215_F())});
         ...
         if(!PreYggdrasilConverter.func_152714_a(this.field_71340_o)) {
            ...
            field_155771_h.info("Done ({})! For help, type \"help\" or \"?\"", new Object[]{s3});
   ...
   public void func_71331_a(String p_71331_1_, ICommandSender p_71331_2_) {
      this.field_71341_l.add(new PendingCommand(p_71331_1_, p_71331_2_));
   }
