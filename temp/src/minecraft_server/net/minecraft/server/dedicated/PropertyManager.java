...
public class PropertyManager {
   ...
   public PropertyManager(File p_i46372_1_) {
      ...
      if(p_i46372_1_.exists()) {
         ...
         try {
            ...
            field_164440_a.warn("Failed to load {}", new Object[]{p_i46372_1_, exception});
            this.func_73666_a();
         } finally {
         ...
         field_164440_a.warn("{} does not exist", new Object[]{p_i46372_1_});
         this.func_73666_a();
      }
   ...
   public void func_73668_b() {
      ...
      try {
         ...
         field_164440_a.warn("Failed to save {}", new Object[]{this.field_73673_c, exception});
         this.func_73666_a();
      } finally {
   ...
   public boolean func_187239_a(String p_187239_1_) {
      return this.field_73672_b.containsKey(p_187239_1_);
   }

   public void func_187238_b(String p_187238_1_) {
      this.field_73672_b.remove(p_187238_1_);
   }
}
