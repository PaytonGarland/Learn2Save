...
public class PreYggdrasilConverter {
      ...
      if(field_152729_b.exists() && field_152729_b.isFile()) {
         if(userlistbans.func_152691_c().exists()) {
            try {
               ...
               field_152732_e.warn("Could not load existing file {}", new Object[]{userlistbans.func_152691_c().getName(), filenotfoundexception});
            }
         }
         ...
         try {
            ...
            ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
               public void onProfileLookupSucceeded(GameProfile p_onProfileLookupSucceeded_1_) {
                  ...
                  if(astring == null) {
                     PreYggdrasilConverter.field_152732_e.warn("Could not convert user banlist entry for {}", new Object[]{p_onProfileLookupSucceeded_1_.getName()});
               ...
               public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_, Exception p_onProfileLookupFailed_2_) {
                  PreYggdrasilConverter.field_152732_e.warn("Could not lookup user banlist entry for {}", new Object[]{p_onProfileLookupFailed_1_.getName(), p_onProfileLookupFailed_2_});
      ...
      if(field_152728_a.exists() && field_152728_a.isFile()) {
         if(userlistipbans.func_152691_c().exists()) {
            try {
               ...
               field_152732_e.warn("Could not load existing file {}", new Object[]{userlistipbans.func_152691_c().getName(), filenotfoundexception});
            }
         }
         ...
         try {
            ...
            for(String s : map.keySet()) {
               ...
               userlistipbans.func_152687_a(new UserListIPBansEntry(s, date, s1, date1, s2));
            }
      ...
      if(field_152730_c.exists() && field_152730_c.isFile()) {
         if(userlistops.func_152691_c().exists()) {
            try {
               ...
               field_152732_e.warn("Could not load existing file {}", new Object[]{userlistops.func_152691_c().getName(), filenotfoundexception});
            }
         }
         ...
         try {
            ...
            ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_, Exception p_onProfileLookupFailed_2_) {
                  PreYggdrasilConverter.field_152732_e.warn("Could not lookup oplist entry for {}", new Object[]{p_onProfileLookupFailed_1_.getName(), p_onProfileLookupFailed_2_});
                  if(!(p_onProfileLookupFailed_2_ instanceof ProfileNotFoundException)) {
                     throw new PreYggdrasilConverter.ConversionError("Could not request user " + p_onProfileLookupFailed_1_.getName() + " from backend systems", p_onProfileLookupFailed_2_);
                  }
               }
      ...
      if(field_152731_d.exists() && field_152731_d.isFile()) {
         if(userlistwhitelist.func_152691_c().exists()) {
            try {
               ...
               field_152732_e.warn("Could not load existing file {}", new Object[]{userlistwhitelist.func_152691_c().getName(), filenotfoundexception});
            }
         }
      ...
      if(file1.exists() && file1.isDirectory()) {
         ...
         try {
            ...
            ProfileLookupCallback profilelookupcallback = new ProfileLookupCallback() {
               ...
               public void onProfileLookupFailed(GameProfile p_onProfileLookupFailed_1_, Exception p_onProfileLookupFailed_2_) {
                  PreYggdrasilConverter.field_152732_e.warn("Could not lookup user uuid for {}", new Object[]{p_onProfileLookupFailed_1_.getName(), p_onProfileLookupFailed_2_});
                  if(p_onProfileLookupFailed_2_ instanceof ProfileNotFoundException) {
   ...
   private static boolean func_152712_b(PropertyManager p_152712_0_) {
      ...
      if(!flag && !flag1 && !flag2 && !flag3) {
         ...
         if(flag) {
            field_152732_e.warn("* {}", new Object[]{field_152729_b.getName()});
         }

         if(flag1) {
            field_152732_e.warn("* {}", new Object[]{field_152728_a.getName()});
         }

         if(flag2) {
            field_152732_e.warn("* {}", new Object[]{field_152730_c.getName()});
         }

         if(flag3) {
            field_152732_e.warn("* {}", new Object[]{field_152731_d.getName()});
         }
