...
public class RecipesBanners {
   void func_179534_a(CraftingManager p_179534_1_) {
      for(EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
         p_179534_1_.func_92103_a(ItemBanner.func_190910_a(enumdyecolor, (NBTTagList)null), new Object[]{"###", "###", " | ", Character.valueOf('#'), new ItemStack(Blocks.field_150325_L, 1, enumdyecolor.func_176765_a()), Character.valueOf('|'), Items.field_151055_y});
      }
