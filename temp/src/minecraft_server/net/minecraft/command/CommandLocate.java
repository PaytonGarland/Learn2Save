...
public class CommandLocate extends CommandBase {
   ...
   public void func_184881_a(MinecraftServer p_184881_1_, ICommandSender p_184881_2_, String[] p_184881_3_) throws CommandException {
      if(p_184881_3_.length != 1) {
         ...
         if(blockpos != null) {
            p_184881_2_.func_145747_a(new TextComponentTranslation("commands.locate.success", new Object[]{s, Integer.valueOf(blockpos.func_177958_n()), Integer.valueOf(blockpos.func_177952_p())}));
         } else {
