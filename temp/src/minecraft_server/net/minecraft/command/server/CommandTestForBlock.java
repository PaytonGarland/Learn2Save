            ...
            if(!world.func_175667_e(blockpos)) {
               ...
               if(block1 != block) {
                  ...
                  try {
                     ...
                     throw new CommandException("commands.testforblock.failed.data", new Object[]{Integer.valueOf(blockpos.func_177958_n()), Integer.valueOf(blockpos.func_177956_o()), Integer.valueOf(blockpos.func_177952_p()), Integer.valueOf(i), Integer.valueOf(Integer.parseInt(p_184881_3_[4]))});
                  } catch (NumberFormatException var13) {
                     throw new CommandException("commands.testforblock.failed.data", new Object[]{Integer.valueOf(blockpos.func_177958_n()), Integer.valueOf(blockpos.func_177956_o()), Integer.valueOf(blockpos.func_177952_p()), iblockstate.toString(), p_184881_3_[4]});
                  }
               } else {
                  if(flag) {
