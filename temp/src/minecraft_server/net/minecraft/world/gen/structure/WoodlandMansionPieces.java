      ...
      private void func_191123_a(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_, Rotation p_191123_3_, WoodlandMansionPieces.SimpleGrid p_191123_4_, @Nullable WoodlandMansionPieces.SimpleGrid p_191123_5_) {
         for(int i = 0; i < p_191123_4_.field_191150_c; ++i) {
            for(int j = 0; j < p_191123_4_.field_191149_b; ++j) {
               BlockPos lvt_8_1_ = p_191123_2_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.SOUTH), 8 + (i - this.field_191137_d) * 8);
               lvt_8_1_ = lvt_8_1_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), (j - this.field_191136_c) * 8);
               ...
               if(WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i) && !flag) {
                  p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof", lvt_8_1_.func_177981_b(3), p_191123_3_));
                  if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j + 1, i)) {
                     BlockPos blockpos1 = lvt_8_1_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 6);
                     p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "roof_front", blockpos1, p_191123_3_));
                  }

                  if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j - 1, i)) {
                     BlockPos blockpos5 = lvt_8_1_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 0);
                  ...
                  if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i - 1)) {
                     BlockPos blockpos6 = lvt_8_1_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.WEST), 1);
                  ...
                  if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, j, i + 1)) {
                     BlockPos blockpos7 = lvt_8_1_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 6);
         ...
         if(p_191123_5_ != null) {
            for(int k = 0; k < p_191123_4_.field_191150_c; ++k) {
               for(int i1 = 0; i1 < p_191123_4_.field_191149_b; ++i1) {
                  BlockPos lvt_8_3_ = p_191123_2_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.SOUTH), 8 + (k - this.field_191137_d) * 8);
                  lvt_8_3_ = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), (i1 - this.field_191136_c) * 8);
                  ...
                  if(WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k) && flag1) {
                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k)) {
                        BlockPos blockpos8 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 7);
                        p_191123_1_.add(new WoodlandMansionPieces.MansionTemplate(this.field_191134_a, "small_wall", blockpos8, p_191123_3_));
                     }

                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
                        BlockPos blockpos9 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.WEST), 1);
                     ...
                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
                        BlockPos blockpos10 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.WEST), 0);
                     ...
                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                        BlockPos blockpos11 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 6);
                     ...
                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 + 1, k)) {
                        if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
                           BlockPos blockpos12 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 7);
                        ...
                        if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                           BlockPos blockpos13 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.EAST), 8);
                     ...
                     if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1 - 1, k)) {
                        if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k - 1)) {
                           BlockPos blockpos14 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.WEST), 2);
                        ...
                        if(!WoodlandMansionPieces.Grid.func_191109_a(p_191123_4_, i1, k + 1)) {
                           BlockPos blockpos15 = lvt_8_3_.func_177967_a(p_191123_3_.func_185831_a(EnumFacing.WEST), 1);
